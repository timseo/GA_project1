$(document).ready(function() {
  ...
  function playAgain() {
    ...
    $("#match").append('<br> <br> <div id="playerOneWins"><span id="playerAlpha">Alpha :  </span>0</div> <span id="tournamentColon">:</span> <div id="playerTwoWins">0<span id="playerBravo">  : Bravo</span></div>');
    $('#buttonOne').css('visibility', 'visible');
    $('#buttonTwo').css('visibility', 'visible');
    ascore = 1;
    bscore = 1;
